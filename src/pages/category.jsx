                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <nav className="flex mb-4 text-sm text-indigo-600 font-medium">
                                ...
                                <span className="text-gray-500 capitalize">{category.replace(/-/g, " ")}</span>
                            </nav>
            ...
            <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-12">
                {products.length === 0 ? (
                    <div className="text-center py-20 bg-white rounded-3xl shadow-sm border border-dashed border-gray-300">
                        <h2 className="text-2xl text-gray-400 font-medium">للأسف مفيش منتجات في القسم ده حالياً</h2>
